...
#Title
#title = Label(root, text = "Upload a video")
...
def main(video_path):
    ...
    #		     Select the model 			#
    #########################################
    model_path = 'C:/Users/Alvin/Desktop/Year 3 Sem 1/Intelligent System/GUI/models/frozen_inference_graph.pb'
    ...
    while True:
        ...
        if int(vs.get(cv2.CAP_PROP_POS_FRAMES)) == int(vs.get(cv2.CAP_PROP_FRAME_COUNT)):
